                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 w-full">
                                        <div className="md:col-span-2">
                                            <div className="flex flex-col max-[500px]:items-center gap-3">
                                                ...
                                                <h6 className="font-normal text-base leading-7 text-gray-500">{item.name}</h6>
                                        ...
                                        <div className="flex items-center max-[500px]:justify-center md:justify-end max-md:mt-3 h-full">
                                            <button onClick={() => handleRemoveItem(item._id)} className="text-red-500 hover:text-red-700 transition-all duration-300">
                                                Remove
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <div className="col-span-12 xl:col-span-4 bg-gray-50 w-full max-xl:px-6 max-w-3xl xl:max-w-lg mx-auto lg:pl-8 py-24">
                            ...
                            <div className="mt-8">
                                <div className="flex items-center justify-between pb-6">
                                    ...
                                    <p className="font-medium text-lg leading-8 text-black">${items.reduce((total, item) => total + item.price * item.quantity, 0).toFixed(2)}</p>
                                </div>
                                <form>
                                    ...
                                    <div className="flex pb-6">
                                        <div className="relative w-full">
                                            ...
                                            <button id="dropdown-button" data-target="dropdown-delivery" className="dropdown-toggle flex-shrink-0 py-2.5 px-5 inline-flex justify-center items-center text-sm font-medium text-center text-gray-900 bg-gray-50 border border-gray-300 rounded-r-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200" type="button">Type</button>
                                        </div>
                                    </div>
                                    <div id="dropdown-delivery" className="hidden z-10 w-44 bg-white rounded-lg shadow border">
                                        <ul className="py-2 text-sm text-gray-700" aria-labelledby="dropdown-button">
                                            <li><a href="#" className="block px-4 py-2 hover:bg-gray-100">Second Delivery</a></li>
                                            <li><a href="#" className="block px-4 py-2 hover:bg-gray-100">Fast Delivery</a></li>
                                            <li><a href="#" className="block px-4 py-2 hover:bg-gray-100">Morning Delivery</a></li>
                                            <li><a href="#" className="block px-4 py-2 hover:bg-gray-100">Nominated Delivery</a></li>
                                        </ul>
                                    </div>
                                </form>
                                <div className="flex items-center justify-between pb-6 border-b border-gray-300">
                                    <p className="font-normal text-lg leading-8 text-gray-900">Total</p>
                                    <p className="font-medium text-lg leading-8 text-black">${items.reduce((total, item) => total + item.price * item.quantity, 0).toFixed(2)}</p>
                                </div>
                                <div className="mt-6">
                                    <Link to="/checkout" className="inline-flex items-center justify-center w-full px-4 py-3 text-base font-medium text-white bg-black border border-transparent rounded-lg shadow-sm hover:bg-gray-900">
                                        Proceed to Checkout
                                    </Link>
                                </div>
                            </div>
