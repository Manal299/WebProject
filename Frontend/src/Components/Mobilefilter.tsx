    ...
    <>
      {isOpen && (
        <div
          ...
          aria-modal="true"
        >
          <div className="fixed inset-0 bg-black bg-opacity-25 transition-opacity" onClick={toggleMenu}></div>

          <div className="fixed inset-0 z-40 flex">
            <div className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl transform transition-transform duration-300 ease-in-out">
