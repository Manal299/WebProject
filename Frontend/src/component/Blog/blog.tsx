...
import Bloghead from '../BlogHeader/bloghead';
...
const BlogPage: React.FC<BlogPageProps> = ({ blogs }) => {
  ...
  return (
    <>
      ...
      <hr className="blogline" style={{ borderColor: blog.color }} />
      <div className="blog-container">
        <div className="sidebar">
          <div className="author-section">
            <div className="author-details">
              <h2 className="authorname" style={{ color: blog.color }}>{blog.author}</h2>
              <p>{blog.about}</p>
          ...
          <div className="tags-container">
            ...
            <div className="tags">
              {blog.keywords.split(',').map((tag, index) => (
                <span key={index} className="tag" style={{ backgroundColor: blog.color }}>
                  {tag.trim()}
                </span>
              ))}
            </div>
